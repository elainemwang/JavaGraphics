...
public class MovingShapePanel extends JPanel implements Runnable {
    ...
    public MovingShapePanel() {
        ...
        sh = new Shape(0, 0, 90, 20, Color.PINK, 3, 3);
    ...
    public void paint(Graphics window) {
        ...
        */
        ...
        if (!(sh.getxPos() >= 10-sh.getWidth() && sh.getxPos() <= 730-sh.getWidth())) {
            sh.setxSpeed(-sh.getxSpeed());
        }
        else if (!(sh.getyPos() >= 10-sh.getHeight() && sh.getyPos() <= 530+sh.getHeight())) {
